        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Merci de renseigner une adresse valide<!-- data-validator-validemail-message to override -->";
      ...
      ajax: {
		...
		builtInValidators: {
			...
			required: {
				name: "Required",
				type: "required",
				message: "Ce champs est obligatoire<!-- data-validator-required-message to override -->"
			},
			checkone: {
				name: "Checkone",
				type: "minchecked",
